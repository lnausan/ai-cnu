...
const DEFAULT_IMAGES = [
  {
    src: '/01.jpeg',
    alt: 'Imagen 01 - Real o no?'
  },
  {
    src: '/02.jpeg',
    alt: 'Imagen 02 - Real o no?'
  },
  {
    src: '/03.jpeg',
    alt: 'Imagen 03 - Real o no?'
  },
  {
    src: '/04.jpeg',
    alt: 'Imagen 04 - Real o no?'
  }
];
...
export default function DomeGallery({
  ...
  const openItemFromElement = useCallback(
    (el: HTMLElement) => {
      ...
      const rawSrc = (parent as HTMLElement).dataset.src || el.querySelector('img')?.getAttribute('src') || '';
